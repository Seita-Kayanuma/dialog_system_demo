...
#from espnet.nets.pytorch_backend.vari_mlp.encoder_layer import EncoderLayer
...
class MLPEncoder(AbsEncoder):
    ...
    def __init__(
        ...
        act_out="",
        shift_size: int =1,
        mlp_module_kernel: int =15,
        mlp_module_dropout_rate: int =0,
    ):
