...
# from tools.espnet2.asr.encoder.mlp_encoder import MLPEncoder
...
from espnet2.asr.encoder.contextual_block_parallel_conformer_encoder import (
    ContextualBlockParallelConformerEncoder,  # editted by Jin Sakuma
)
from espnet2.asr.encoder.contextual_block_bifurcation_conformer_encoder import (
    ContextualBlockBifurcationConformerEncoder,  # editted by Jin Sakuma
)
...
#         mlp=MLPEncoder,
        ...
        contextual_block_dual_delay_conformer=ContextualBlockDualDelayConformerEncoder,     # add
        contextual_block_dual_delay_conformer2=ContextualBlockDualDelayConformerEncoder2,   # add
        contextual_block_parallel_conformer=ContextualBlockParallelConformerEncoder,        # add
        contextual_block_bifurcation_conformer=ContextualBlockBifurcationConformerEncoder,  # add
