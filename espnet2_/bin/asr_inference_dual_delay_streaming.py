#!/usr/bin/env python3
import argparse
from espnet.nets.batch_beam_search_online_dual_delay import BatchBeamSearchOnlineDualDelay
...
#         logging.warning(f"# enc shape: {enc[0].shape}")
        ...
        nbest_hyps, is_eou, block_idx = self.beam_search(
            x=enc[0],
            #x2=enc[0],
            x2=enc_r[0],
        ...
        if is_final or is_eou:
            self.reset()
            
        return ret, is_eou, block_idx
